...
```perl
use OnlinePetstore::Object::StoreApi;
```
...
my $api_instance = OnlinePetstore::StoreApi->new(
);
...
my $order = OnlinePetstore::Object::Order->new(); # Order | order placed for purchasing the pet
