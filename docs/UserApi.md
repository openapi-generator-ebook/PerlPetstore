...
```perl
use OnlinePetstore::Object::UserApi;
```
...
my $api_instance = OnlinePetstore::UserApi->new(
);

my $user = OnlinePetstore::Object::User->new(); # User | Created user object
...
my $user = [OnlinePetstore::Object::ARRAY[User]->new()]; # ARRAY[User] | List of user object
...
my $user = OnlinePetstore::Object::User->new(); # User | Updated user object
