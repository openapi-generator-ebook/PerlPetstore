...
has _cfg => ( is => 'ro',
              isa => 'OnlinePetstore::Configuration',
              default => sub { OnlinePetstore::Configuration->new() },
              );
...
sub _build_af {
    ...
    return OnlinePetstore::ApiFactory->new(%args);
}
