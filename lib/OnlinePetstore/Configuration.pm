...
#
package OnlinePetstore::Configuration;
...
=head1 Name
        ...
        OnlinePetstore::Configuration - holds the configuration for all OnlinePetstore Modules
...
default: OpenAPI-Generator/0.3.1/perl
...
sub new {
    ...
    $p{http_timeout} //= 180;
    $p{http_user_agent} //= 'OpenAPI-Generator/0.3.1/perl';
    ...
    # base_url
    $p{base_url} //= 'http://api.pubi.org/v2';
